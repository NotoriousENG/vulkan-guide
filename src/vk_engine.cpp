...
void VulkanEngine::init()
{
	...
	init_default_renderpass(); // need to create the renderpass BEFORE the framebuffers, because the framebuffers are created for a specific renderpass
...
void VulkanEngine::init_vulkan()
{
	...
	// initialze the memory allocator
...
// Framebuffers are created from a given renderpass, and they act as link between the attachments of the renderpass and the real images that they should render to.
...
void VulkanEngine::init_pipelines()
{
	...
	// make sure that the triangle frag shader is holding the compiled colored_triangle.frag
	pipelineBuilder._shaderStages.push_back(
		vkinit::pipeline_shader_stage_create_info(VK_SHADER_STAGE_FRAGMENT_BIT, triangleFragShader)
	);
